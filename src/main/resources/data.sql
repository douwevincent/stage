...
INSERT INTO app_setting (id, cle, valeur, type, description, secret, modifiable, updated_at) VALUES
                                         (1, 'SMTP_HOST', 'smtp.gmail.com', 'STRING', 'Hote SMTP', false, true, CURRENT_TIMESTAMP),
                                         ...
                                         (18, 'SMTP_FROM_ADDRESS', 'stagemanager82@gmail.com', 'STRING', 'Adresse expediteur SMTP', false, true, CURRENT_TIMESTAMP),
                                         (3, 'SMTP_USERNAME', 'stagemanager82@gmail.com', 'STRING', 'Utilisateur SMTP', false, true, CURRENT_TIMESTAMP),
                                         (4, 'SMTP_PASSWORD', 'Change me', 'STRING', 'Mot de passe SMTP', true, true, CURRENT_TIMESTAMP),
                                         (5, 'MAIL_TEMPLATE_BODY', 'Bonjour ${encadreur.nom},\n\nVous avez accueilli des étudiants de l''École Nationale Supérieure Polytechnique de Maroua (ENSPM) dans votre entreprise. Leurs stages vont bientôt s''achever. Nous souhaitons que vous utilisiez le lien {LIEN_EVALUATION} pour les évaluer avant le ${stage.sessionEvaluation.dateLimite}.\n\nBien cordialement,\nScolarité ENSPM', 'TEXT', 'Template principal des mails', false, true, CURRENT_TIMESTAMP),
                                         (19, 'MAIL_PUBLIC_EVALUATION_URL_PREFIX', 'http://localhost:8080', 'STRING', 'Prefixe URL publique pour evaluation encadreur (ex: https://domaine.tld)', false, true, CURRENT_TIMESTAMP),
