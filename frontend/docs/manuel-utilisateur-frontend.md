...
## 0. Captures d'ecran integrees

Deposez les images dans `docs/images/manuel-complet/` en conservant les noms ci-dessous.
Ordre de prise recommande: [docs/images/checklist-captures.md](images/checklist-captures.md)

### 0.1 Connexion
<!-- ![Connexion](images/manuel-complet/01-login.png) -->
![](images/manuel-complet/01-login.png)

### 0.2 Tableau de bord
<!-- ![Tableau de bord](images/manuel-complet/02-dashboard.png) -->
![](images/manuel-complet/02-dashboard.png)

### 0.3 Inscriptions - filtres
<!-- ![Inscriptions - filtres](images/manuel-complet/03-inscriptions-filtres.png) -->
![](images/manuel-complet/03-inscriptions-filtres.png)

### 0.4 Inscriptions - modal ajout
<!-- ![Inscriptions - modal ajout](images/manuel-complet/04-inscriptions-modal-ajout.png) -->
![](images/manuel-complet/04-inscriptions-modal-ajout.png)

### 0.5 Stages - liste
<!-- ![Stages - liste](images/manuel-complet/05-stages-liste.png) -->
![](images/manuel-complet/05-stages-liste.png)


### 0.6 Stages - assignation encadreur
<!--  ![Stages - assignation encadreur](images/manuel-complet/06-stages-assignation-encadreur.png) -->
![](images/manuel-complet/06-stages-assignation-encadreur.png)

### 0.7 Resultats evaluations
<!--  ![Resultats evaluations](images/manuel-complet/07-evaluations-resultats.png) -->
![](images/manuel-complet/07-evaluations-resultats.png)

### 0.8 Export evaluations
<!-- ![Export evaluations](images/manuel-complet/08-evaluations-export.png) -->
![](images/manuel-complet/08-evaluations-export.png)

### 0.9 Notifications
<!--  ![Notifications](images/manuel-complet/09-systeme-notifications.png) -->
![](images/manuel-complet/09-systeme-notifications.png)

### 0.10 Mails envoyes
<!-- ![Mails envoyes](images/manuel-complet/10-systeme-mails.png) -->
![](images/manuel-complet/10-systeme-mails.png)

### 0.11 Utilisateurs
<!-- ![Utilisateurs](images/manuel-complet/11-systeme-utilisateurs.png) -->
![](images/manuel-complet/11-systeme-utilisateurs.png)

### 0.12 Evaluation publique encadreur
<!-- ![Evaluation publique encadreur](images/manuel-complet/12-public-evaluation.png) -->
...
### 5.2 Niveaux
Objectif: créer et maintenir les niveaux (ex: L1, L2, M1, M2).
...
Erreur possible:
- Message Impossible de generer la fiche PDF.

### 8.5 Exporter les evaluations
Objectif: produire un export des résultats.

Étapes:
1. Ouvrir Évaluation > Exporter les evaluations.
...
Erreurs possibles:
- Message Completez les informations de l export: un paramètre manque.
...
2. Compléter les champs demandés.
3. Soumettre.

Résultat attendu:
- Déclaration enregistrée ou message d'erreur explicite.
...
Erreurs possibles:
- Lien d evaluation introuvable.
- Lien d evaluation expire.
...
- Cette evaluation a deja ete soumise.
